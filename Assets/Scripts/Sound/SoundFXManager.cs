...
public class SoundFXManager : MonoBehaviour
{
        ...
        soundSettings = new Dictionary<Sound, SoundSettings>()
    {
        ...
        { Sound.TimeRewind, new SoundSettings(2f, audioSourceRef.volume, audioSourceRef.spatialBlend) },
        { Sound.ManualRewind, new SoundSettings(2f, audioSourceRef.volume, audioSourceRef.spatialBlend) },
        ...
        { Sound.RobotMovement, new SoundSettings(0.6f, 0.6f, audioSourceRef.spatialBlend) },
        { Sound.RobotJump, new SoundSettings(audioSourceRef.pitch, 0.4f, audioSourceRef.spatialBlend) },
